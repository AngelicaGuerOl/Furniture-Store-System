...
public class CtrlUsuario {
    public boolean agregar(Usuario obj){
        ...
        String query="INSERT INTO usuarios(id_usuario,nombre_usuario,apellidos_usuario,telefono_usuario,password_usuario,rol_usuario) VALUES (?,?,?,?,?,?)";
        try(PreparedStatement st=cn.prepareStatement(query)){
            st.setInt(1, 0);
            st.setString(2, obj.getNombre_usuario());
            st.setString(3, obj.getApellidos_usuario());
            st.setString(4, obj.getTelefono_usuario());
            st.setString(5, obj.getPassword_usuario());
            st.setString(6, obj.getRol_usuario());
            st.executeUpdate();
            st.close();
            return true;
    ...
    public boolean actualizar(Usuario obj){
        Connection cn=Conexion.Conectar();
        String query="UPDATE usuarios SET nombre_usuario=?,apellidos_usuario=?,telefono_usuario=?,password_usuario=?,rol_usuario=? WHERE id_usuario=?";
        try(PreparedStatement st=cn.prepareStatement(query)){
            st.setString(1, obj.getNombre_usuario());
            st.setString(2, obj.getApellidos_usuario());
            st.setString(3, obj.getTelefono_usuario());
            st.setString(4, obj.getPassword_usuario());
            st.setString(5, obj.getRol_usuario());
