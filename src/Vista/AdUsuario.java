 ...
 */
public class AdUsuario extends javax.swing.JInternalFrame {
    private FMenu ventana;
    private FMenu menu;
    DefaultTableModel modelo=new DefaultTableModel();
    private int id_usuario;
    private boolean is_selected = false;
     private Vector<Integer> idRolUsuario = new Vector<>();
    
    /**
     * Creates new form VCliente
     */
    public AdUsuario(FMenu ventana) {
        initComponents();
        ...
        tb_adusuario=new JTable(modelo);
        tb_adusuario.setDefaultEditor(Object.class, null);
        
        scp_adusuario.setViewportView(tb_adusuario);
        this.cargarTabla();
        
        tb_adusuario.addMouseListener(new MouseAdapter(){
        @Override
        public void mouseClicked(MouseEvent e){
            int fila_seleccionada=tb_adusuario.rowAtPoint(e.getPoint());
            int columna_seleccionada=0;
            if(fila_seleccionada>-1){
                is_selected=true;
                id_usuario=(int) modelo.getValueAt(fila_seleccionada, columna_seleccionada);
                btn_actualizar.setEnabled(true);
                btn_eliminar.setEnabled(true);
                cargarInformacionUsuario(id_usuario);
            }
        }
    });
    }
    ...
    private void initComponents() {
        ...
        text_apellidos.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(text_password, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(scp_adusuario, javax.swing.GroupLayout.PREFERRED_SIZE, 1018, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(136, 136, 136))
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel9)))
                .addGap(18, 18, 18)
                .addComponent(scp_adusuario, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        if(text_nombre.getText().isEmpty()||text_apellidos.getText().isEmpty()||text_telefono.getText().isEmpty()
            ...
            usuario.setNombre_usuario(text_nombre.getText().trim());
            usuario.setApellidos_usuario(text_apellidos.getText().trim());
            usuario.setTelefono_usuario(text_telefono.getText().trim());
            usuario.setPassword_usuario(text_password.getText().trim());
            usuario.setRol_usuario(cmb_rol.getSelectedItem().toString());
            
            if(ctUsuario.actualizar(usuario)){
                JOptionPane.showMessageDialog(null, "Usuario actualizado");
                this.cargarTabla();
                this.limpiar();
                cmb_rol.setSelectedItem("Seleccione el rol");
            }else{
                 JOptionPane.showMessageDialog(null, "Fallo la actualizacion de usuario");
            }
        }
        }
        ...
        if(is_selected){
            ...
            if(opcion==JOptionPane.YES_OPTION){
                if(ctUsuario.eliminar(this.id_usuario)){
                    JOptionPane.showMessageDialog(null, "El usuario seleccionado se eliminó correctamente");
                    this.cargarTabla();
                    this.limpiar();
                }else{
                    JOptionPane.showMessageDialog(null, "El usuario no se eliminó");
                }
            }
        }else{
    ...
    private void cargarInformacionUsuario(int idUsuario){
        try{
            ...
            if(rs.next()){
                text_nombre.setText(rs.getString("nombre_usuario"));
                text_apellidos.setText(rs.getString("apellidos_usuario"));
                text_telefono.setText(rs.getString("telefono_usuario"));
                text_password.setText(rs.getString("password_usuario"));
                cmb_rol.setSelectedItem(rs.getString("rol_usuario"));
            }
            cn.close();
        }catch(SQLException e){
